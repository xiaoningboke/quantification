...
class ClassesModel extends Model{
    ...
    *$rows分页的条数
    ...
    public function querymajor(){
      ...
      */
    public function addClasses($cl_grade,$cl_major,$cl_classes,$cl_headmaster,$cl_remarks)
    {
        $m = $this->retrieveheadmaster($cl_headmaster);
        $data = new ClassesModel;
        $data ->cl_grade = $cl_grade;
        $data->cl_major = $cl_major;
 ...
 * @return [type]             [description]
 */
    public function editclasses($Id,$cl_grade,$cl_major,$cl_classes,$cl_headmaster,$cl_remarks)
    {
